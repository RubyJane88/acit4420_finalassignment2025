...
class TestCourierOptimizer:
    ...
    def test_route_optimization_by_priority(self):
        ...
        deliveries = [
            {'customer': 'Low Priority', 'latitude': 59.91, 'longitude': 10.74, 
             'priority': 'LOW', 'weight_kg': 5},
            {'customer': 'High Priority', 'latitude': 59.92, 'longitude': 10.75, 
             'priority': 'HIGH', 'weight_kg': 3},
            {'customer': 'Medium Priority', 'latitude': 59.90, 'longitude': 10.73, 
             'priority': 'MEDIUM', 'weight_kg': 7},
        ]
    ...
    def test_route_optimization_single_delivery(self):
        ...
        deliveries = [
            {'customer': 'Only One', 'latitude': 59.91, 'longitude': 10.74, 
             'priority': 'HIGH', 'weight_kg': 5}
        ]
